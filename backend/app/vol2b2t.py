...
def render_vol2b2t_chart(coin: str, entry_ts: str):
    ...
    try:
        ...
        bars = a.get_ohlcv(base_asset, interval="15m", limit=60)
    except Exception as e:
    ...
    # Plotting
    fig, (ax1, ax2) = plt.subplots(2, 1, gridspec_kw={'height_ratios': [3, 1]}, figsize=(12, 8), dpi=100)
    ...
    # Volume 20-SMA and 10x threshold
    ...
    vol_thresh = [v * 10 for v in vol_sma]
    ax2.plot(x, vol_thresh, color="yellow", linewidth=1, linestyle="--", label="10x Threshold")
    ax2.legend(facecolor="#111217", edgecolor="#2c2d35", labelcolor="white")
