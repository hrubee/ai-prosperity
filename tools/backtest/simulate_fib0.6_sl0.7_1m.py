...
print("=== 1-MINUTE GRANULARITY INTRABAR REPLAY: ENTRY @ 0.6 FIB | SL @ 0.7 FIB ===")
...
for s in spikes:
    ...
    entry_px = high - (0.60 * rng)  # Entry at 0.6 Fib
    sl_px = high - (0.70 * rng)     # SL at 0.7 Fib
    risk = entry_px - sl_px
    if risk <= 0:
        continue
...
print("-" * 85)
print(f"SUMMARY (Entry 0.6 Fib / SL 0.7 Fib / 1m Intrabar Replay):")
