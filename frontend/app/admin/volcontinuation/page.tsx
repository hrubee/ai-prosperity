...
export default function VolContinuationDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      fetch("/api/volcontinuation/trades")
        .then((res) => res.json())
        .then((data) => {
      ...
      fetch("/api/volcontinuation/screener")
        .then((res) => res.json())
        .then((data) => {
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="mx-auto max-w-7xl">
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="pill text-sm bg-blue-500/20 text-blue-400">VolContinuation Monitor</span>
          </div>
              ...
              <table className="w-full text-left text-sm whitespace-nowrap">
                <thead className="bg-black/20 text-slate-400">
                  <tr>
                    ...
                    <th className="p-4 font-medium text-right">20 Candle Average</th>
          ...
          <h1 className="mb-6 text-2xl font-bold">VolContinuation Trade Executions</h1>
          ...
          {loading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
              {trades.map((trade) => {
                ...
                const chartUrl = `/api/volcontinuation/chart/${trade.coin}?entry_ts=${trade.entry_time}`;
